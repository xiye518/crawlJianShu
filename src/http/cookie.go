...
func readSetCookies(h *Header) []*Cookie {
	cookies := []*Cookie{}
	set_cookies,ok:=h.FindAll("Set-Cookie")
	if !ok{
		return cookies
	}

	for _, line := range set_cookies {
...
// isCookieDomainName returns whether c is a valid domain name or a valid
// domain name with a leading dot '.'.  It is almost a direct copy of
// package net'c isDomainName.
