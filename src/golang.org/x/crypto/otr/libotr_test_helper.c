...
// Use of this source code is governed by q BSD-style
...
main() {
  ...
  // We have to write the private key information to q file because the libotr
  // API demands q filename to read from.
